...
///
/// # Errors
/// Returns [`commenter_cat_core::CommenterCatError`] if a structured format fails to serialize.
pub fn render(comments: &[Comment], format: OutputFormat) -> CommenterCatResult<String> {
    match format {
