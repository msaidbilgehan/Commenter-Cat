...
/// directive (Idea §3, §4a) — `commenter-cat:*` plus the native tool directives Commenter-Cat must
...
pub fn classify(
    ...
    // Control directive (`commenter-cat:*`, `# noqa`, `// eslint-disable`, …).
...
mod tests {
    ...
    fn test_directives_across_languages() {
        ...
        assert_eq!(
            classify_line(Language::Python, "# commenter-cat:disable=D417", 4),
            CommentKind::Directive
        );
    }
